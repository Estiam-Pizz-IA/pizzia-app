...
it('Connexion avec un utilisateur valide', () => {   
    ...
    cy.wait(5000)
    cy.get('.navbar-module__QXtwcq__nav_item').contains('PROFILE').click({force:true}) 
    cy.get('.page-module__h4SgrW__profil_item').contains('test3.cypress@gmail.com').should('be.visible')
})
